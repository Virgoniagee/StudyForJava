...
import com.virgonia.spring5.ioc.SpringConfig;
import com.virgonia.spring5.ioc.User;
import com.virgonia.spring5.bean.*;
import com.virgonia.spring5.service.UserService;
...
public class IOCTest {
    ...
    * com.virgonia.spring5.ioc.User@481a15ff
    * com.virgonia.spring5.ioc.User@481a15ff
    *
    * bean中添加属性scope="prototype"设置为多例模式 调用getBean时才创建对象
    * com.virgonia.spring5.ioc.User@78186a70
    * com.virgonia.spring5.ioc.User@306279ee
    * */
    @Test
    ...
    * 同时 .xml中配置的init-method="initMethod" destroy-method="destroyMethod"也会在每次创建时执行
    * 则需要单独的一个.xml文件
    ...
    * */
    ...
    /*
    * Druid的数据池连接中的属性名称需要对应好
    * driverClassName
    * url
    * username
    * password
    * 通过properties取值需要用context名称空间 其内的键值对用${xxx}取
    * */
    @Test
    ...
    /*
    * use-default-filters="false" 表示不使用默认的Filter 再在其内
    * <context:include-filter type="annotation" expression="org.springframework.stereotype.Controller"/>
    * 表示要扫描expression中的内容
    * <context:exclude-filter type="annotation" expression="org.springframework.stereotype.Controller"/>
    * 表示除了expression中的内容都要扫描
    * 使用创建对象的注解 区分用途 不写value时默认是当前类名的首字母小写
    * 设置位exclude时 type是annotation好像所有的注解都不能被扫描到
    * */
    @Test
    public void testAnnotation(){
        //使用.xml
        //ApplicationContext context = new ClassPathXmlApplicationContext("annotation.xml");
        //使用全注解方式加载配置类 实际开发中由Spring Boot完成
